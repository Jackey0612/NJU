...
public class NoticesUtil {
    ...
    public void getNotices(ArrayList<String> paragraphList) {
        ...
        for (int i=0;i<lowTitle1.size();i++) System.out.println(lowTitle1.get(i).getText());
        System.out.println(highTitleB);
        for (int i=0;i<lowTitle2.size();i++) System.out.println(lowTitle2.get(i).getText());
        System.out.println(highTitleC);
        for (int i=0;i<lowTitle3.size();i++) System.out.println(lowTitle3.get(i).getText());
